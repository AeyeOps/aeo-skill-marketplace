...
def analyze_prompt(prompt: str) -> list[dict]:
    ...
    if aggressive_count >= 2:
        issues.append({
            ...
            "suggestion": "Opus responds well to gentler language. Use 'Use when...' or 'Prefer X because...'",
        })
    ...
    if has_command and not has_motivation:
        issues.append({
            ...
            "suggestion": "Add 'because...' to explain why. Opus generalizes better with context.",
        })
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Analyze prompts for Opus compatibility"
    )
    parser.add_argument(
        "file",
        nargs="?",
